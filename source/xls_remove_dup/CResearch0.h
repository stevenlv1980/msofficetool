...
class CResearch0 : public COleDispatchDriver
{
public:
	CResearch0(){} // 调用 COleDispatchDriver 默认构造函数
	CResearch0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CResearch0(const CResearch0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
