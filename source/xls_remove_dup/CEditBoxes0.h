...
class CEditBoxes0 : public COleDispatchDriver
{
public:
	CEditBoxes0(){} // 调用 COleDispatchDriver 默认构造函数
	CEditBoxes0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CEditBoxes0(const CEditBoxes0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Add)(double Left, double Top, double Width, double Height, EditBox * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(Item)(VARIANT Index, VARIANT * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PVARIANT ;
