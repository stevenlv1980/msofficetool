...
class CTextBox0 : public COleDispatchDriver
{
public:
	CTextBox0(){} // 调用 COleDispatchDriver 默认构造函数
	CTextBox0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CTextBox0(const CTextBox0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
