...
class CComments0 : public COleDispatchDriver
{
public:
	CComments0(){} // 调用 COleDispatchDriver 默认构造函数
	CComments0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CComments0(const CComments0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Item)(long Index, Comment * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(get__Default)(long Index, Comment * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_I4 VTS_PDISPATCH ;
