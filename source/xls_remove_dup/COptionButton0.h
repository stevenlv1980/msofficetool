...
class COptionButton0 : public COleDispatchDriver
{
public:
	COptionButton0(){} // 调用 COleDispatchDriver 默认构造函数
	COptionButton0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	COptionButton0(const COptionButton0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
