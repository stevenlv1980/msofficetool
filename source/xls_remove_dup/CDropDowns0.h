...
class CDropDowns0 : public COleDispatchDriver
{
public:
	CDropDowns0(){} // 调用 COleDispatchDriver 默认构造函数
	CDropDowns0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDropDowns0(const CDropDowns0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Add)(double Left, double Top, double Width, double Height, VARIANT Editable, DropDown * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_VARIANT VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, Left, Top, Width, Height, &Editable, RHS);
		return result;
	}
