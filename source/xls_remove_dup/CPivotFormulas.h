...
public:
	...
	STDMETHOD(_Add)(LPCTSTR Formula, PivotFormula * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_BSTR VTS_PDISPATCH ;
		InvokeHelper(0x825, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, Formula, RHS);
		return result;
	}
	STDMETHOD(Item)(VARIANT Index, PivotFormula * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(get__Default)(VARIANT Index, PivotFormula * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
	...
	STDMETHOD(Add)(LPCTSTR Formula, VARIANT UseStandardFormula, PivotFormula * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_BSTR VTS_VARIANT VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, Formula, &UseStandardFormula, RHS);
		return result;
	}
