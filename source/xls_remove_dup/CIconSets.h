...
class CIconSets : public COleDispatchDriver
{
public:
	CIconSets(){} // 调用 COleDispatchDriver 默认构造函数
	CIconSets(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CIconSets(const CIconSets& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
