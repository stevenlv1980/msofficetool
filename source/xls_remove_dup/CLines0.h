...
class CLines0 : public COleDispatchDriver
{
public:
	CLines0(){} // 调用 COleDispatchDriver 默认构造函数
	CLines0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CLines0(const CLines0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
