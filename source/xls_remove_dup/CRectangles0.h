...
class CRectangles0 : public COleDispatchDriver
{
public:
	CRectangles0(){} // 调用 COleDispatchDriver 默认构造函数
	CRectangles0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CRectangles0(const CRectangles0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
