...
class CIconSet : public COleDispatchDriver
{
public:
	CIconSet(){} // 调用 COleDispatchDriver 默认构造函数
	CIconSet(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CIconSet(const CIconSet& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(get_ID)(XlIconSet * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_PI4 ;
	...
	STDMETHOD(get__Default)(VARIANT Index, Icon * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(get_Item)(VARIANT Index, Icon * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
