...
class COval0 : public COleDispatchDriver
{
public:
	COval0(){} // 调用 COleDispatchDriver 默认构造函数
	COval0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	COval0(const COval0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
