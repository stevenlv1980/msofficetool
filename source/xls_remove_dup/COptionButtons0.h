...
class COptionButtons0 : public COleDispatchDriver
{
public:
	COptionButtons0(){} // 调用 COleDispatchDriver 默认构造函数
	COptionButtons0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	COptionButtons0(const COptionButtons0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
