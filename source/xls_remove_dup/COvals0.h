...
class COvals0 : public COleDispatchDriver
{
public:
	COvals0(){} // 调用 COleDispatchDriver 默认构造函数
	COvals0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	COvals0(const COvals0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
