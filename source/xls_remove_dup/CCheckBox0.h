...
class CCheckBox0 : public COleDispatchDriver
{
public:
	CCheckBox0(){} // 调用 COleDispatchDriver 默认构造函数
	CCheckBox0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CCheckBox0(const CCheckBox0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
