...
class CSpinners0 : public COleDispatchDriver
{
public:
	CSpinners0(){} // 调用 COleDispatchDriver 默认构造函数
	CSpinners0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CSpinners0(const CSpinners0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
