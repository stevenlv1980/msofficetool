...
class CScrollBars0 : public COleDispatchDriver
{
public:
	CScrollBars0(){} // 调用 COleDispatchDriver 默认构造函数
	CScrollBars0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CScrollBars0(const CScrollBars0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
