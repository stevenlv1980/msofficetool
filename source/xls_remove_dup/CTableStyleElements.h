...
public:
	...
	STDMETHOD(Item)(XlTableStyleElementType Index, TableStyleElement * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(get__Default)(XlTableStyleElementType Index, TableStyleElement * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_I4 VTS_PDISPATCH ;
