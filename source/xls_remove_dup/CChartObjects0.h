...
class CChartObjects0 : public COleDispatchDriver
{
public:
	CChartObjects0(){} // 调用 COleDispatchDriver 默认构造函数
	CChartObjects0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CChartObjects0(const CChartObjects0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(_Copy)(VARIANT * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_PVARIANT ;
		InvokeHelper(0xa31, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, RHS);
		return result;
	}
	...
	STDMETHOD(get_ProtectChartObject)(BOOL * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_PBOOL ;
		InvokeHelper(0x5f9, DISPATCH_PROPERTYGET, VT_HRESULT, (void*)&result, parms, RHS);
		return result;
	}
	STDMETHOD(put_ProtectChartObject)(BOOL RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0x5f9, DISPATCH_PROPERTYPUT, VT_HRESULT, (void*)&result, parms, newValue);
		return result;
	}
	...
	STDMETHOD(Add)(double Left, double Top, double Width, double Height, ChartObject * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(_Default)(VARIANT Index, LPDISPATCH * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
