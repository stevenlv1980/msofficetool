...
class CPicture0 : public COleDispatchDriver
{
public:
	CPicture0(){} // 调用 COleDispatchDriver 默认构造函数
	CPicture0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CPicture0(const CPicture0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
