...
class CDrawings0 : public COleDispatchDriver
{
public:
	CDrawings0(){} // 调用 COleDispatchDriver 默认构造函数
	CDrawings0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDrawings0(const CDrawings0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Add)(double X1, double Y1, double X2, double Y2, BOOL Closed, Drawing * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_R8 VTS_R8 VTS_R8 VTS_R8 VTS_BOOL VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, X1, Y1, X2, Y2, Closed, RHS);
		return result;
	}
