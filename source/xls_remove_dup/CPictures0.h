...
class CPictures0 : public COleDispatchDriver
{
public:
	CPictures0(){} // 调用 COleDispatchDriver 默认构造函数
	CPictures0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CPictures0(const CPictures0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
