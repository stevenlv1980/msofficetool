...
public:
	...
	STDMETHOD(Add)(VARIANT Obj, LPDISPATCH * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, &Obj, RHS);
		return result;
	}
	STDMETHOD(Delete)(VARIANT Index)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT ;
		InvokeHelper(0x75, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, &Index);
		return result;
	}
	STDMETHOD(DeleteAll)()
	{
