...
class CChartTitle0 : public COleDispatchDriver
{
public:
	CChartTitle0(){} // 调用 COleDispatchDriver 默认构造函数
	CChartTitle0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CChartTitle0(const CChartTitle0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
