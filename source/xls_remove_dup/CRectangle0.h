...
class CRectangle0 : public COleDispatchDriver
{
public:
	CRectangle0(){} // 调用 COleDispatchDriver 默认构造函数
	CRectangle0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CRectangle0(const CRectangle0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
