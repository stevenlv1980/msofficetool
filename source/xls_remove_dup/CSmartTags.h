...
public:
	...
	STDMETHOD(Add)(LPCTSTR SmartTagType, SmartTag * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_BSTR VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, SmartTagType, RHS);
		return result;
	}
	...
	STDMETHOD(get__Default)(VARIANT Index, SmartTag * * RHS)
	{
		HRESULT result;
