...
public:
	...
	STDMETHOD(get_GroupBox)(GroupBox * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_PDISPATCH ;
		InvokeHelper(0x341, DISPATCH_PROPERTYGET, VT_HRESULT, (void*)&result, parms, RHS);
		return result;
	}
	STDMETHOD(Add)(double Left, double Top, double Width, double Height, OptionButton * * RHS)
	{
		HRESULT result;
