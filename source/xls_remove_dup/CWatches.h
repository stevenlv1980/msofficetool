...
public:
	...
	STDMETHOD(Add)(VARIANT Source, Watch * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, &Source, RHS);
		return result;
	}
	...
	STDMETHOD(get__Default)(VARIANT Index, Watch * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
	...
	STDMETHOD(get_Item)(VARIANT Index, Watch * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
