...
class CTextBoxes0 : public COleDispatchDriver
{
public:
	CTextBoxes0(){} // 调用 COleDispatchDriver 默认构造函数
	CTextBoxes0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CTextBoxes0(const CTextBoxes0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
