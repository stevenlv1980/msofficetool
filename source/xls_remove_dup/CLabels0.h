...
class CLabels0 : public COleDispatchDriver
{
public:
	CLabels0(){} // 调用 COleDispatchDriver 默认构造函数
	CLabels0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CLabels0(const CLabels0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
