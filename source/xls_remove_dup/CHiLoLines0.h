...
class CHiLoLines0 : public COleDispatchDriver
{
public:
	CHiLoLines0(){} // 调用 COleDispatchDriver 默认构造函数
	CHiLoLines0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CHiLoLines0(const CHiLoLines0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
