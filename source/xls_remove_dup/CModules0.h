...
class CModules0 : public COleDispatchDriver
{
public:
	CModules0(){} // 调用 COleDispatchDriver 默认构造函数
	CModules0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CModules0(const CModules0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
