...
class CGroupObject0 : public COleDispatchDriver
{
public:
	CGroupObject0(){} // 调用 COleDispatchDriver 默认构造函数
	CGroupObject0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CGroupObject0(const CGroupObject0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
