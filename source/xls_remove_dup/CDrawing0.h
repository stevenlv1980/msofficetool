...
class CDrawing0 : public COleDispatchDriver
{
public:
	CDrawing0(){} // 调用 COleDispatchDriver 默认构造函数
	CDrawing0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDrawing0(const CDrawing0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(AddVertex)(double Left, double Top, VARIANT * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_R8 VTS_R8 VTS_PVARIANT ;
		InvokeHelper(0x259, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, Left, Top, RHS);
		return result;
	}
	STDMETHOD(Reshape)(long Vertex, BOOL Insert, VARIANT Left, VARIANT Top, VARIANT * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_I4 VTS_BOOL VTS_VARIANT VTS_VARIANT VTS_PVARIANT ;
		InvokeHelper(0x25c, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, Vertex, Insert, &Left, &Top, RHS);
		return result;
	}
	STDMETHOD(get_Vertices)(VARIANT Index1, VARIANT Index2, VARIANT * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_PVARIANT ;
		InvokeHelper(0x26d, DISPATCH_PROPERTYGET, VT_HRESULT, (void*)&result, parms, &Index1, &Index2, RHS);
		return result;
	}
