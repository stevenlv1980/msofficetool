...
public:
	...
	STDMETHOD(Add)(LPCTSTR Caption, VARIANT Before, VARIANT Restore, Menu * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_BSTR VTS_VARIANT VTS_VARIANT VTS_PDISPATCH ;
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_HRESULT, (void*)&result, parms, Caption, &Before, &Restore, RHS);
		return result;
	}
	...
	STDMETHOD(get__Default)(VARIANT Index, Menu * * RHS)
	{
		HRESULT result;
	...
	STDMETHOD(get_Item)(VARIANT Index, Menu * * RHS)
	{
		HRESULT result;
		static BYTE parms[] = VTS_VARIANT VTS_PDISPATCH ;
