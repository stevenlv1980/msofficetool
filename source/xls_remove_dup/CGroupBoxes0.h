...
class CGroupBoxes0 : public COleDispatchDriver
{
public:
	CGroupBoxes0(){} // 调用 COleDispatchDriver 默认构造函数
	CGroupBoxes0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CGroupBoxes0(const CGroupBoxes0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Add)(double Left, double Top, double Width, double Height, GroupBox * * RHS)
	{
		HRESULT result;
