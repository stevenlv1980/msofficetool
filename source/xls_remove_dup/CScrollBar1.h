...
class CScrollBar1 : public COleDispatchDriver
{
public:
	CScrollBar1(){} // 调用 COleDispatchDriver 默认构造函数
	CScrollBar1(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CScrollBar1(const CScrollBar1& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
