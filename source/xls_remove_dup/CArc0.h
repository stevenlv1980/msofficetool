...
class CArc0 : public COleDispatchDriver
{
public:
	CArc0(){} // 调用 COleDispatchDriver 默认构造函数
	CArc0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CArc0(const CArc0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
