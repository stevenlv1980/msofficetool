...
class CDialogSheets0 : public COleDispatchDriver
{
public:
	CDialogSheets0(){} // 调用 COleDispatchDriver 默认构造函数
	CDialogSheets0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDialogSheets0(const CDialogSheets0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Add)(VARIANT Before, VARIANT After, VARIANT Count, DialogSheet * * RHS)
	{
		HRESULT result;
