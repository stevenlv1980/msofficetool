...
class CGroupBox0 : public COleDispatchDriver
{
public:
	CGroupBox0(){} // 调用 COleDispatchDriver 默认构造函数
	CGroupBox0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CGroupBox0(const CGroupBox0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
