...
class CListRows0 : public COleDispatchDriver
{
public:
	CListRows0(){} // 调用 COleDispatchDriver 默认构造函数
	CListRows0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CListRows0(const CListRows0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
