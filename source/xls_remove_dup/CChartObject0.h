...
class CChartObject0 : public COleDispatchDriver
{
public:
	CChartObject0(){} // 调用 COleDispatchDriver 默认构造函数
	CChartObject0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CChartObject0(const CChartObject0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
