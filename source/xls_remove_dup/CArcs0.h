...
class CArcs0 : public COleDispatchDriver
{
public:
	CArcs0(){} // 调用 COleDispatchDriver 默认构造函数
	CArcs0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CArcs0(const CArcs0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	STDMETHOD(Add)(double X1, double Y1, double X2, double Y2, Arc * * RHS)
	{
		HRESULT result;
